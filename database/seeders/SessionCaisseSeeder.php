...
class SessionCaisseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('sessions_caisse')->insert([
            ...
            'montant_ouverture' => 200.00,
            'montant_fermeture_theorique' => 1500.00,
            'montant_fermeture_reel' => 1500.00,
            'ecart' => 0,
            'statut' => 'fermee',
        ...
        DB::table('sessions_caisse')->insert([
            ...
            'date_fermeture' => null,
            'montant_ouverture' => 200.00,
            'montant_fermeture_theorique' => 200.00,
            'montant_fermeture_reel' => null,
            'ecart' => 0,
            'statut' => 'ouverte',
            'created_at' => now(),
            'updated_at' => now(),
