    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium">Bienvenue sur OMenu</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">La solution complète pour la gestion de votre
                    restaurant. <br>Gérez vos commandes, produits et tables en toute simplicité.</p>
