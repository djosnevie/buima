...
<head>
    <meta charset="utf-8">
    <title>Vente journalière FOOD</title>
    <style>
        body {
    ...
    <table class="items-table">
        ...
        <tbody>
            @foreach($items as $item)
                <tr>
                    <td style="text-align: center;">{{ number_format($item->qte, 2, ',', '') }}</td>
                    <td class="designation">{{ $item->designation }}</td>
                    <td>{{ $fmt($item->pu) }} @if($devise == 'FC') F @endif</td>
